...
# Setup OSC Server Node
class LogicNodeSetupOSCServer(NLActionNode):
    bl_idname = "LogicNodeSetupOSCServer"
...
_nodes.append(LogicNodeSetupOSCServer)


# Receive OSC Message Node
class LogicNodeReceiveOSCMessage(NLActionNode):
    bl_idname = "LogicNodeReceiveOSCMessage"
...
_nodes.append(LogicNodeReceiveOSCMessage)

#OSC sequencer
class LogicNodeOSCSequencer(NLActionNode):
    bl_idname = "LogicNodeOSCSequencer"
    bl_label = "OSC Sequencer"
    bl_icon = 'SEQ_SEQUENCER'
    nl_category = "Network"
    nl_module = 'actions'
    ...
    def init(self, context):
        ...
        self.inputs.new(NLConditionSocket.bl_idname, "Start Recording")
        self.inputs.new(NLConditionSocket.bl_idname, "Stop Recording")
        
        self.inputs.new(NLFloatFieldSocket.bl_idname, "Max Duration")
        self.inputs[-1].value = 5.0
        
        self.inputs.new(NLConditionSocket.bl_idname, "Play")
        ...
        self.outputs.new(NLConditionSocket.bl_idname, "Recording")
        self.outputs.new(NLConditionSocket.bl_idname, "Playing")
        self.outputs.new(NLConditionSocket.bl_idname, "Finished Playing")
        self.outputs.new(NLParameterSocket.bl_idname, "Message")

    def get_netlogic_class_name(self):
        return "ULOSCSequencer"
